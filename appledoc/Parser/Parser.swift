...
class Parser: Task {
	...
	*/
	...
	private func parsePathOrFile(_ path: PathInfo) throws {
	...
	private func parseFolder(_ path: PathInfo) throws {
	...
	private func parseFile(_ path: PathInfo) throws {
	...
	private func parseObjectiveCFromFile(_ path: PathInfo) throws {
