...
func gerror(@autoclosure _ message: () -> String, function: String = #function, filename: String = #file, line: Int = #line) {
	Logger.error?.message(message(), function: function, filename: filename, line: line)
}

func gwarn(@autoclosure _ message: () -> String, function: String = #function, filename: String = #file, line: Int = #line) {
	Logger.warning?.message(message(), function: function, filename: filename, line: line)
}

func ginfo(@autoclosure _ message: () -> String, function: String = #function, filename: String = #file, line: Int = #line) {
	Logger.info?.message(message(), function: function, filename: filename, line: line)
}

func gverbose(@autoclosure _ message: () -> String, function: String = #function, filename: String = #file, line: Int = #line) {
	Logger.verbose?.message(message(), function: function, filename: filename, line: line)
}

func gdebug(@autoclosure _ message: () -> String, function: String = #function, filename: String = #file, line: Int = #line) {
