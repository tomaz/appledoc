...
- (NSInteger)markdownParser:(MarkdownParser *)parser parseAutoLink:(const struct buf *)link type:(enum mkd_autolink)type output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseCodeSpan:(const struct buf *)text output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseTripleEmphasis:(const struct buf *)text output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseDoubleEmphasis:(const struct buf *)text output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseEmphasis:(const struct buf *)text output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseImageLink:(const struct buf *)link title:(const struct buf *)title alt:(const struct buf *)alt output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseLineBreak:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseLink:(const struct buf *)link title:(const struct buf *)title content:(const struct buf *)content output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseRawHTMLTag:(const struct buf *)tag output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseStrikeThrought:(const struct buf *)text output:(struct buf *)buffer;
- (NSInteger)markdownParser:(MarkdownParser *)parser parseSuperScript:(const struct buf *)text output:(struct buf *)buffer;

// Low level callbacks - if not implemented, copies directly into output
- (void)markdownParser:(MarkdownParser *)parser parseEntity:(const struct buf *)entity output:(struct buf *)buffer;
- (void)markdownParser:(MarkdownParser *)parser parseNormalText:(const struct buf *)text output:(struct buf *)buffer;

// Header and footer
- (void)markdownParser:(MarkdownParser *)parser parseDocHeader:(struct buf *)buffer;
- (void)markdownParser:(MarkdownParser *)parser parseDocFooter:(struct buf *)buffer;
