...
- (void)parseObjectsFromPaths:(NSArray *)paths toStore:(id)toStore {
...
- (void)parseDocumentsFromPaths:(NSArray *)paths toStore:(id)toStore {
	NSParameterAssert(paths != nil);
	NSParameterAssert(toStore != nil);
...
- (void)parseCustomDocumentFromPath:(NSString *)path outputSubpath:(NSString *)subpath key:(id)key toStore:(id)toStore {
