//
//  OutputGenerator+IndexSubclassAPI.h
//  appledoc
//
...
*/
@interface OutputGenerator (IndexSubclassAPI)
...
The message is sent from the @c OutputGenerator::outputDataForIndex() as the first message. 
...
@see OutputGenerator::outputDataForIndex
...
The message is sent from the @c OutputGenerator::outputDataForIndex() as the last message. It 
...
The message is sent from the @c OutputGenerator::outputDataForIndex() just before index group 
...
The message is sent from the @c OutputGenerator::outputDataForIndex() as the last group 
...
This message is sent from @c OutputGenerator::outputDataForIndex() for each group member. 
...
@c OutputGenerator(IndexParsingAPI) category.
